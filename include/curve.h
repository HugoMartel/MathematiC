/*
    sdl_gui/curve.h -- Simple graph widget for showing a function plot, modified to add functionalities to the Widget
...
{
public:
    Curve(Widget *parent, const std::string &caption = "Untitled");
